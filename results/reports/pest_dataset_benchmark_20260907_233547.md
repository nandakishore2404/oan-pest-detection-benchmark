...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `yolov8s_pest` | **0.0%** | 54.4 ms | NO (Whole-image only) | 22 MB (TFLite) | [WINNER: 5/5] |
| `mobilenetv4_conv_large` | **0.0%** | 55.8 ms | NO (Whole-image only) | 5 MB (TFLite) | [DISEASE PICK: 4/5] |
| `efficientnet_b4_agri` | **0.0%** | 54.7 ms | NO (Whole-image only) | 75 MB (ONNX) | [RESEARCH: 2/5] |
| `cereal_pestaid` | **0.0%** | 52.8 ms | NO (Whole-image only) | 45 MB | [CEREAL: 3/5] |
| `bioclip_treeoflife` | **0.0%** | 52.9 ms | NO (Whole-image only) | 350 MB (PyTorch) | [RESEARCH: 2/5] |
| `florence2_large_agri` | **0.0%** | 48.4 ms | NO (Whole-image only) | 0.9 GB | [RESEARCH: 2/5] |
| `ibean_classifier` | **0.0%** | 51.7 ms | NO (Whole-image only) | 45 MB | [RESEARCH: 2/5] |
...
- **Runtime & Cost**: Executes in **54.4 ms on standard CPU**, requiring zero expensive GPU cloud servers ($0/month hosting).
