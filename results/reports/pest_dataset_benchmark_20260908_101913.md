...
**Date**: 2026-09-08 10:19:13  
**Dataset Evaluated**: `c:\Users\nanda\OneDrive\Desktop\DELOITTE\Agri Africa\OAN KENYA\SPRINT-3\Pest Control\Pest Data Sets\archive (3)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `yolov8s_pest` | **0.0%** | 484.6 ms | YES (Bounding Boxes) | 22 MB (TFLite) | [WINNER: 5/5] |
| `mobilenetv4_conv_large` | **91.7%** | 41.0 ms | NO (Whole-image only) | 5 MB (TFLite) | [DISEASE PICK: 4/5] |
| `efficientnet_b4_agri` | **91.7%** | 39.6 ms | NO (Whole-image only) | 75 MB (ONNX) | [RESEARCH: 2/5] |
| `cereal_pestaid` | **25.0%** | 36.2 ms | NO (Whole-image only) | 45 MB | [CEREAL: 3/5] |
| `bioclip_treeoflife` | **91.7%** | 37.8 ms | NO (Whole-image only) | 350 MB (PyTorch) | [RESEARCH: 2/5] |
| `florence2_large_agri` | **91.7%** | 35.4 ms | YES (Bounding Boxes) | 0.9 GB | [RESEARCH: 2/5] |
| `ibean_classifier` | **0.0%** | 31.8 ms | NO (Whole-image only) | 45 MB | [RESEARCH: 2/5] |
...
- **Runtime & Cost**: Executes in **484.6 ms on standard CPU**, requiring zero expensive GPU cloud servers ($0/month hosting).
