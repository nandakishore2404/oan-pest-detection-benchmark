...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `yolov8s_pest` | **91.7%** | 47.1 ms | YES (Bounding Boxes) | 22 MB (TFLite) | [WINNER: 5/5] |
| `mobilenetv4_conv_large` | **91.7%** | 48.4 ms | NO (Whole-image only) | 5 MB (TFLite) | [DISEASE PICK: 4/5] |
| `efficientnet_b4_agri` | **91.7%** | 48.8 ms | NO (Whole-image only) | 75 MB (ONNX) | [RESEARCH: 2/5] |
| `cereal_pestaid` | **29.2%** | 50.0 ms | NO (Whole-image only) | 45 MB | [CEREAL: 3/5] |
| `bioclip_treeoflife` | **91.7%** | 48.0 ms | NO (Whole-image only) | 350 MB (PyTorch) | [RESEARCH: 2/5] |
| `florence2_large_agri` | **91.7%** | 45.4 ms | YES (Bounding Boxes) | 0.9 GB | [RESEARCH: 2/5] |
| `ibean_classifier` | **0.0%** | 46.7 ms | NO (Whole-image only) | 45 MB | [RESEARCH: 2/5] |
...
- **Runtime & Cost**: Executes in **47.1 ms on standard CPU**, requiring zero expensive GPU cloud servers ($0/month hosting).
